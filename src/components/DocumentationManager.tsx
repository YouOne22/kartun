...
type Doc = { id: string; photoUrlThumb: string; caption: string | null; status: string; rejectionReason: string | null; event: { title: string } };
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {items.map(item => (
          <article key={item.id} className="overflow-hidden rounded-2xl border bg-white/85 shadow-sm">
            <img src={item.photoUrlThumb} alt={item.caption || item.event.title} className="h-48 w-full object-cover" />
            <div className="p-4">
